...
| PRJ-01 R2b | that clause names `id`, the column the table actually has | pending | deployed v410; the rebuild started 08:51 UTC is the test — symbol chunks have been 0 since 2026-09-11 | — |
...
| PRJ-01 R7 | production: a full rebuild reaches `pipeline_end` | pending | first attempt died on the second defect (R2b); second attempt running on v410 | — |
