...
- **Cycle 5 (2026-09-26)** — #436 (V3 of release 1.18.0 recorded), #437 (B-28: the sync-history panel read a row the API no longer returned — found while scoping T07d, and both suites were green), #438 (T07d: per-connection nightly jobs), #439 (B-21: background work outliving its test on the shared SQLite connection). **Operator questions open: 0.**
