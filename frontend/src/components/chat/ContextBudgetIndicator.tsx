...
export function ContextBudgetIndicator({ breakdown }: ContextBudgetIndicatorProps) {
  ...
  return (
    <div className="relative">
      ...
      {hoveredIdx !== null && (
        <div className="absolute bottom-full left-0 mb-1 z-50 bg-surface-2 border border-border-default rounded px-2 py-1 text-kicker text-text-primary shadow-(--shadow-1) whitespace-nowrap">
