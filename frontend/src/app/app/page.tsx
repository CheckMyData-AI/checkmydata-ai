                      ...
                      <Tooltip label={notesOpen ? "Hide saved queries" : "Saved queries"} position="bottom">
                        ...
                        >
                          ...
                          {notesCount > 0 && !notesOpen && (
                            <span className="absolute -top-0.5 -right-0.5 w-3.5 h-3.5 rounded-full bg-primary text-primary-foreground text-[10px] font-bold flex items-center justify-center">
