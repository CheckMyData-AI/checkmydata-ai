...
class TestAskEndpointAgent:
    ...
    async def test_ask_conversational_response(self, mock_agent, auth_client, project_id, connection_id):
    ...
    @pytest.mark.asyncio
    @patch("app.api.routes.chat._agent")
    async def test_ask_sql_result_response(self, mock_agent, auth_client, project_id, connection_id):
    ...
    async def test_ask_creates_session(self, mock_agent, auth_client, project_id):
        ...
        resp2 = await auth_client.post("/api/chat/ask", json={
            "project_id": project_id,
...
class TestStreamEndpointAgent:
    ...
    async def test_stream_without_connection(self, mock_agent, auth_client, project_id):
        ...
        resp = await auth_client.post("/api/chat/ask/stream", json={
            "project_id": project_id,
