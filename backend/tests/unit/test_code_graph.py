...
# ---------------------------------------------------------------------------
# R3-1 dangling-edge pruning and CODEIDX-C4 moved to
# tests/unit/test_graph_incremental_writes_a_delta.py on 2026-09-08. They used to
# test `CodeGraphService._merge_graphs` / `_prune_dangling_edges`, which the delta
# write replaced; the functions are gone and the specifications now run against
# `save_incremental` itself.
# ---------------------------------------------------------------------------
